...
public class ColorSliders extends JFrame implements ChangeListener {
    ...
    public ColorSliders() {
        ...
        redval = new JTextField("0",4);
        redval.setEditable(false);
        greenval = new JTextField("0",4);
        greenval.setEditable(false);
        blueval = new JTextField("0",4);
...
//        if (source.getValueIsAdjusting() != true) {
            ...
            canvas.repaint();
            redval.setText(red.getValue()+"");
            greenval.setText(green.getValue()+"");
            blueval.setText(blue.getValue()+"");
//        }
    }
