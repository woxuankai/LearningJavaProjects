...
public class LottoMadness extends JFrame {
    ...
    JTextField got3 = new JTextField("0",10);
    JLabel got4Label = new JLabel("4 of 6: ", JLabel.RIGHT);
    JTextField got4 = new JTextField("0",10);
    JLabel got5Label = new JLabel("5 of 6: ", JLabel.RIGHT);
    JTextField got5 = new JTextField("0",10);
    ...
    JTextField drawings = new JTextField("0",10);
    JLabel yearsLabel = new JLabel("Years: ", JLabel.RIGHT);
    JTextField years = new JTextField(10);
